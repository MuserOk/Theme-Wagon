...
export default function FeatureCard() {
  return (
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon1.png" alt="icon" />
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon2.png" alt="icon" />
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon3.png" alt="icon" />
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon4.png" alt="icon" />
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon5.png" alt="icon" />
    ...
    <div className='flex flex-col justify-center items-center w-50 gap-4'>
      <img className='w-22' src="/themewagon/4.features/icon6.png" alt="icon" />
